...
<section class="section">
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body ">
                <form action="<?= site_url('event/create-event') ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="row">
                        <div class="form-group col-6">
                            <label>Judul Event *</label>
                            <input type="text" name="judul" class="form-control <?= $validation->hasError('judul') ? 'is-invalid' : null ?>" autofocus value="<?= old('judul') ?>">
                            <?php
                        ...
                        <div class="form-group col-6">
                            ...
                            <select class="form-control <?= $validation->hasError('slug_kategori') ? 'is-invalid' : null ?>" name="slug_kategori">
                                ...
                                <?php foreach ($kategori as $key => $value) : ?>
                                    <?php if (old('slug_kategori') == $value->slug_kategori) : ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="penyelenggara" class="form-control <?= $validation->hasError('penyelenggara') ? 'is-invalid' : null ?>" value="<?= old('penyelenggara') ?>">
                        <?php
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="date" name="start_event" class="form-control <?= $validation->hasError('start_event') ? 'is-invalid' : null ?>" value="<?= old('start_event') ?>">
                            <?php
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="date" name="end_event" class="form-control" value="<?= old('end_event') ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Image Event *</label>
                        <!-- <input type="file" name="img_event" class="form-control"> -->
