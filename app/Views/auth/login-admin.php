    ...
    <div class="flex h-screen">
        ...
        <div class="w-4/12 bg-white flex">
            ...
            <div class="max-w-sm m-auto">
                ...
                <?php endif; ?>
                <h1 class="font-sans font font-semibold text-3xl my-6">Halo Admin</h1>
                ...
                <form class="w-full" action="<?= site_url('/login-admin/store') ?>" method="POST">
                    <?= csrf_field() ?>
                    <div class="grid gap-5">
                        <div class="flex items-center border-b border-gray-400 py-2">
                            <input name="username" class="appearance-none bg-transparent border-none w-full text-gray-400 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Username">
                        </div>
                        <?php
                    ...
                    <button class="bg-black h-12 rounded-lg w-full my-14" type="submit">
