...
<section class="section">
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body ">
                <form action="<?= site_url('/kontak/create-kontak') ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="form-group">
                        <label>Title *</label>
                        <input type="text" name="title" class="form-control <?= $validation->hasError('title') ? 'is-invalid' : null ?>" autofocus value="<?= old('title') ?>">
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="keterangan" class="form-control <?= $validation->hasError('keterangan') ? 'is-invalid' : null ?>" style="height: 150px;"><?= old('keterangan') ?></textarea>
                        <?php
