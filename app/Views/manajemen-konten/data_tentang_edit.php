...
<section class="section">
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body ">
                <form action="<?= site_url('/tentang-kami/update/' . $data_tentang->id_tentang) ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <input type="hidden" name="_method" value="PUT">
                    <input type="hidden" name="gambarLama" value="<?= $data_tentang->img_samping ?>">
                    <div class="form-group">
                        <label>Slogan *</label>
                        <input type="text" name="slogan" class="form-control <?= $validation->hasError('slogan') ? 'is-invalid' : null ?>" autofocus value="<?= old('slogan', $data_tentang->slogan) ?>">
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="deskripsi" class="form-control <?= $validation->hasError('deskripsi') ? 'is-invalid' : null ?>" style="height: 150px;"><?= old('deskripsi', $data_tentang->deskripsi) ?></textarea>
                        <?php
                    ...
                    <div class="form-group">
                        ...
                        <img src="<?= base_url('template/assets/img/manajemen-konten/' . $data_tentang->img_samping) ?>" alt="" class="preview-img mt-2" width="200px">
                    </div>
